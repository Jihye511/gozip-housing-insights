      ...
      <div class="overflow-y-auto pr-1 grow" style="max-height: calc(90vh - 160px);">
        ...
        <div class="mb-2">
          <label class="text-sm font-medium">
            시도 선택 <span class="text-red-500">*</span>
          </label>
        ...
        <div class="mb-2" v-if="gugunList.length">
          <label class="text-sm font-medium">
            구군 선택 <span class="text-red-500">*</span>
          </label>
        ...
        <div class="mb-4" v-if="dongList.length">
          <label class="text-sm font-medium">
            동 선택 <span class="text-red-500">*</span>
          </label>
        ...
        <div class="mb-4">
          ...
          <div class="space-y-1 text-sm text-gray-700">
            <div>
              ...
              <label class="ml-4"><input type="checkbox" value="학교 근처" v-model="env" /> 학교 근처 (도보 10분 이내)</label>
            </div>
            <div>
              <label><input type="checkbox" value="조용한 주거지" v-model="env" /> 소음이 적은 환경</label>
              <label class="ml-4"><input type="checkbox" value="보안 우수" v-model="env" /> 보안 시설 우수</label>
            </div>
            <div>
        ...
        <div class="mb-4">
          ...
          <div class="space-y-1 text-sm text-gray-700">
            ...
            <label class="ml-10"><input type="checkbox" value="실거주" v-model="purpose" /> 실거주용</label>
          </div>
        </div>
        ...
        <!-- 추천 결과 -->
        <div v-if="responseData" ref="resultSection" class="mt-4 border-t pt-4 text-sm text-gray-700">
...
export default {
  ...
  methods: {
    ...
    confirmRecommendation() {
      ...
      axios
        .post('http://localhost:8080/api/apt/aptseqList', { aptNames }, {
